	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>User: 000<?php echo ($summeryResult['userid']);?></strong><small>Period:<?php echo $summeryResult['periodid'];?><br><?php echo $convert;?></small></div></div>
            </div>
            </td>
