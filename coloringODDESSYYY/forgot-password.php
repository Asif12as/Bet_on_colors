  ...
  <div class="appContent1 pb-0">
    <form action="#" id="forgotform">
      ...
      <div class="text-center mt-3">
        <button type="submit"  style="width:80%; border-radius: 5px; border: white; height:55px; font-weight: 400; font-size: 17px; background-color: #DAA520; color: white;">Continue</button> 
      </div></div>
    </form>
...
<?php include("include/footer.php");?>
  ...
  <input type="tel" id="otp" name="otp" class="form-control" placeholder="Enter OTP" onKeyPress="return isNumber(event)" >
     <input type="hidden" id="userid" name="userid" value="">
      ...
      <div class="text-center mt-3">
             <button type="submit" style="width:80%;border: white; border-radius: 5px; height:55px; font-weight: 400; font-size: 17px; background-color: #DAA520; color: white;">Submit OTP</button> 
        </div>
        </form>          
        </div>
      </div>
