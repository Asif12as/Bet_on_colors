                                            ...
                                            t._l(t.items.rows, function (e, i) {
                                                return a("van-card", { key: i, attrs: { num: e.num, desc: e.skuText, title: e.title, thumb: t.completePath(e.image) } }, [
                                                    a("div", { attrs: { slot: "price" }, slot: "price" }, [
                                                        e.price > 0 ? a("div", [t._v(t._s("Ã¢â€šÂ¹" + e.price))]) : t._e(),
                                                        t._v(" "),
                                                        ...
                                                        a("div", { staticClass: "booking-info-detail" }, [
                                                            ...
                                                            e.totalFreight > 0
                                                                ? a("div", { staticClass: "booking-info-text", staticStyle: { "font-size": ".45rem" } }, [
                                                                      t._v("\n                                TotalFreight: Ã¢â€šÂ¹" + t._s(e.totalFreight) + "\n                            "),
                                                                  ])
                                                                : t._e(),
                                                            t._v(" "),
                                                            e.totalServiceFees > 0
                                                                ? a("div", { staticClass: "booking-info-text", staticStyle: { "font-size": ".45rem" } }, [
                                                                      t._v("\n                                ServiceFees: Ã¢â€šÂ¹" + t._s(e.totalServiceFees) + "\n                            "),
                                                                  ])
                                                                : t._e(),
                                                            t._v(" "),
                                                            e.totalMoney + e.totalServiceFees > 0
                                                                ? a("div", { staticClass: "booking-info-text", staticStyle: { "font-size": ".45rem" } }, [
                                                                      t._v("\n                                Total: Ã¢â€šÂ¹" + t._s(e.totalMoney + e.totalServiceFees + e.totalFreight) + "\n                            "),
                                                                  ])
                                                                : t._e(),
                                                            t._v(" "),
                                                            e.totalCredit3 > 0
                                                            ...
                                                            [
                                                                [
                                                                    a("van-card", { attrs: { num: t.item.num, desc: t.item.skuText, title: t.item.title, thumb: t.completePath(t.item.image) } }, [
                                                                        a("div", { attrs: { slot: "price" }, slot: "price" }, [
                                                                            t.item.price > 0 ? a("div", [t._v(t._s("Ã¢â€šÂ¹" + t.item.price))]) : t._e(),
                                                                            t._v(" "),
                                                            ...
                                                            [
                                                                a(
                                                                    ...
                                                                    [
                                                                        ...
                                                                        t._v(" "),
                                                                        a("van-cell", { attrs: { title: "Goods Total", value: "Ã¢â€šÂ¹" + t.item.totalMoney } }),
                                                                        t._v(" "),
                                                                        t.item.totalServiceFees > 0 ? a("van-cell", { attrs: { title: "ServiceFees", value: "Ã¢â€šÂ¹" + t.item.totalServiceFees } }) : t._e(),
                                                                        t._v(" "),
                                                                        a("van-cell", { attrs: { title: "Freight", value: "Ã¢â€šÂ¹" + t.item.totalFreight.toFixed(2) } }),
                                                                        t._v(" "),
                                                                        a("van-cell", { attrs: { title: "Total", value: "Ã¢â€šÂ¹" + (t.item.totalFreight + t.item.totalMoney + t.item.totalServiceFees).toFixed(2) } }),
                                                                        t._v(" "),
                                                                        t.item.preMoney > 0 ? a("van-cell", { attrs: { title: "PrePay", value: "-Ã¢â€šÂ¹" + t.item.preMoney } }) : t._e(),
                                                                        t._v(" "),
                ...
                v = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.receive = function () {
                            var t = this;
                            msg.confirm("Are you Confirm receipt the goodsÃ¯Â¼Å¸", function () {
