...
<div class="appHeader1"  style="background-color:#0884fc!important;">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="far fa-chevron-left" style="margin: 10px;color: white;position: absolute;font-size: 18px;" ></i> </a>
 ...
 <!-- form start -->
              <form method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <input type="tel" class="form-control" name="complaint_subject" onKeyPress="return isNumber(event)"  maxlength="10"  maxlength="200" placeholder="WhatsApp Number" required>
                  </div>
