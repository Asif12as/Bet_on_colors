                    ...
                    <div class="row">
                        <div class="col-12">
                           ...
                           <!--         <div class="form-group">
                                ...
                                <input class="buy_now form-control text-light" style="padding: 10px 16px; background-color: blue;"
                                       type="button" id="btnsubmit" name="btnsubmit"
                                       value="Pay With Razorpay Now ₹ <?php echo number_format($_SESSION['finalamount'], 2); ?>"/> 
<br>
 <a href="/checkout1.php"><input class="form-control bg-secondary text-dark" style="padding: 10px 16px;"
                                      ...
                                      <br> -->
                                     <a href="/gatewayekaypay.php"><input class="form-control bg-primary text-dark" style="padding: 10px 16px;"
                                       type="button"
                                       value="Pay With EasyPay Now ₹ <?php echo number_format($_SESSION['finalamount'], 2); ?>"/></a>
                                <?php if ($html) echo $html; //submit request to PayUBiz  ?>
                            </div>
                        </div>
                    </div>
				<!--	<a href="/TxnTest.php"><input class="form-control bg-primary text-dark" style="padding: 10px 16px;"
                                       type="button"
                                       value="Pay With paytm ₹ <?php echo number_format($_SESSION['finalamount'], 2); ?>"/></a>
                                <?php if ($html) echo $html; //submit request to PayUBiz  ?>
                            </div>
                        </div> -->
                    </div>
