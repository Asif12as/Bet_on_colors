	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div>
            <strong>User: ******<?php echo substr($userlevel1Result['mobile'],6);?></strong></div></div>
	  ...
	  ?>
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>User: ******<?php echo substr($userlvl2Result['mobile'],6);?></strong></div></div>
            </div>
            </td>
