...
<title>Softkinger</title><link rel="stylesheet" href="assets/css/style.css?v=2">
...
Invite Bonus & Minimmum Recharge
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Invite Bonus : 80 Rs</li>
    <li class="list-group-item">Minimmum Recharge: 300 Rs</li>
     <li class="list-group-item">Minimmum Withdrawal: 350 Rs</li>
...
<div class="appBottomMenu">
        ...
        <div class="item "> <a href="earn-money.php">
    <p> <i class="icon"><i class="fa fa-user-plus"></i></i> <span>Reffer & Earn</span> </p>
    </a> </div>
    <div class="item "> <a href="gamedashboard.php">
