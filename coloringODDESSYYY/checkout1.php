  ...
  <div id="home" class="tab-pane fade in active">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <span class="value">mintosmind@ybl</span>&emsp;&emsp; &emsp;&emsp;<button class="btn copyBtn1" onclick="window.location.href='upi://pay?pa=mintosmind@ybl&pn=LootleMoney&cu=INR'"> Pay </button>
                <button class="btn copyBtn" data-clipboard-text="mintosmind@ybl">Copy</button>
  ...
  <div id="menu1" class="tab-pane fade">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <span class="value">919057504153</span>
                <button  class="btn copyBtn" data-clipboard-text="919057504153">Copy</button>
            </p>
            <p>
                <span class="label">IFSC Code&nbsp;:</span>
                <span class="value">PYTM0123456</span>
                <button class="btn copyBtn" data-clipboard-text="PYTM0123456">Copy</button>
            </p>
             <p>
                <span class="label">Bank Name&nbsp;:</span>
                <span class="value">Paytm Payment Bank</span>
                <button class="btn copyBtn" data-clipboard-text="Paytm Payment Bank">Copy</button>
            </p>
             <p>
                <span class="label">Name&nbsp;:</span>
                <span class="value">Mohit Soni</span>
                <button class="btn copyBtn" data-clipboard-text="Mohit Soni">Copy</button>
            </p>
        </div>    
  </div>
</div>
...
<form class="paymentRefForm" action="" method="POST" autocomplete="off">
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="refrence" placeholder="Enter Payment Transaction ID" required>
        
    </div>
    <div class="form-group">
        <label style="">Deposit Amount</label>
        <input class="form-control" maxlength="7" type="tel" name="deposit" placeholder="Enter Amount" required>
    </div>
    <div class="form-group">
        <label>Registerd Phone Number</label>
        <input class="form-control" type="tel"  maxlength="10" name="email" placeholder="Enter Registerd Phone Number" required>
    </div>
